...
export const metadata: Metadata = { title: `Orden de Entrega · ${APP_NAME}` };

export default async function OrdenEntregaPage({
  params,
}: {
  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumb={[acc.empresa.nombre, "Administración", "Gestión de Órdenes", "Orden de Entrega"]}
      />
      <main className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
        <GestionOrdenesModule empresa={acc.empresa} tipo="entrega" />
      </main>
    </>
  );
}
