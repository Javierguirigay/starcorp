...
/* Empleados semilla (de nomina.php). Todos de LOTER: la nómina se aísla por
   empresa (empresaId = Empresa.key); las empresas nuevas arrancan sin empleados. */
export const EMPLEADOS_SEED: Empleado[] = [
  {
    id: 1, empresaId: "loter", nombre: "Carlos González", cargo: "Supervisor de campo", dpto: "Operaciones",
  ...
  {
    id: 2, empresaId: "loter", nombre: "María Rodríguez", cargo: "Asistente administrativo", dpto: "Administración",
  ...
  {
    id: 3, empresaId: "loter", nombre: "José Pérez", cargo: "Operador de vacuum", dpto: "Operaciones",
  ...
  {
    id: 4, empresaId: "loter", nombre: "Luis Martínez", cargo: "Ayudante de patio", dpto: "Operaciones",
  ...
  {
    id: 5, empresaId: "loter", nombre: "Ana Salazar", cargo: "Contadora", dpto: "Administración",
  ...
  {
    id: 6, empresaId: "loter", nombre: "Pedro Ramírez", cargo: "Chofer (Lowboy)", dpto: "Operaciones",
...
export const HISTORIAL_SEED: PagoHistorial[] = [
  {
    id: 101, empresaId: "loter", categoria: "Quincenal", desde: "2026-05-16", hasta: "2026-05-31",
  ...
  {
    id: 102, empresaId: "loter", categoria: "Semanal", desde: "2026-06-01", hasta: "2026-06-07",
...
export const ADELANTOS_SEED: AdelantoSueldo[] = [
  {
    id: 1, empresaId: "loter", empleadoId: 3, montoUSD: 30, fecha: "2026-06-10", estado: "pendiente",
    montoDescontadoUSD: 0, aplicaciones: [], nota: "Emergencia familiar",
  },
  {
    id: 2, empresaId: "loter", empleadoId: 1, montoUSD: 50, fecha: "2026-06-05", estado: "pendiente",
